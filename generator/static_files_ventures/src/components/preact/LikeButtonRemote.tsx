  ...
  return (
    <>
      <div class="flex justify-center">
        {!alreadyliked.value ? (
          <div
            class="btn-primary-ventures px-8 py-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 cursor-pointer flex items-center gap-2"
            onClick={likeclicked}
          >
          ...
          <div class="btn-primary-ventures px-8 py-4 flex items-center gap-2">
            {showicon && <IconHeart setclass="w-8 h-8" />}
