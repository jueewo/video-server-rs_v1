...
pub use folder_type_registry::{AgentRole, AppLink, FieldType, FolderTypeDefinition, FolderTypeRegistry, MetadataField};
...
pub async fn folder_agents_handler(
    user: Option<Extension<AuthenticatedUser>>,
    Path(workspace_id): Path<String>,
    Query(query): Query<std::collections::HashMap<String, String>>,
    session: Session,
...
pub async fn folder_ai_context_handler(
    user: Option<Extension<AuthenticatedUser>>,
    Path(workspace_id): Path<String>,
    Query(query): Query<std::collections::HashMap<String, String>>,
    session: Session,
...
pub async fn agent_tool_handler(
    user: Option<Extension<AuthenticatedUser>>,
    Path(workspace_id): Path<String>,
    session: Session,
    State(state): State<Arc<WorkspaceManagerState>>,
...
pub async fn list_agent_tools_handler(
    user: Option<Extension<AuthenticatedUser>>,
    session: Session,
...
pub async fn export_agents_handler(
    user: Option<Extension<AuthenticatedUser>>,
    Path(workspace_id): Path<String>,
    session: Session,
    State(state): State<Arc<WorkspaceManagerState>>,
