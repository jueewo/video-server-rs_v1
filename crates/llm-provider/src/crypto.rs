...
/// Empty input is returned as-is (for keyless providers like Ollama).
...
/// Extract a safe prefix from an API key for display (first 8 chars or "none").
...
// hex decoding helper — avoids pulling in the `hex` crate just for this
mod hex {
